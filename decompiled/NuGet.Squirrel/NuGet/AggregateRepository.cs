...
public class AggregateRepository : PackageRepositoryBase, IPackageLookup, IPackageRepository, IDependencyResolver, IServiceBasedRepository, ICloneableRepository, IOperationAwareRepository
{
