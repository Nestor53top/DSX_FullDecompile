...
internal sealed class NativeMethodsLibudev0 : NativeMethodsLibudev
{
	private const string libudev = "libudev.so.0";

	public override string FriendlyName => "libudev.so.0";

	[DllImport("libudev.so.0", EntryPoint = "udev_new")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_ref")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_unref")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_monitor_new_from_netlink")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_monitor_unref")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_monitor_filter_add_match_subsystem_devtype")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_monitor_enable_receiving")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_monitor_get_fd")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_monitor_receive_device")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_enumerate_new")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_enumerate_ref")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_enumerate_unref")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_enumerate_add_match_subsystem")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_enumerate_scan_devices")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_enumerate_get_list_entry")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_list_entry_get_next")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_list_entry_get_name")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_device_new_from_syspath")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_device_ref")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_device_unref")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_device_get_devnode")]
	[return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "HidSharp.Platform.Utf8Marshaler")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_device_get_parent_with_subsystem_devtype")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_device_get_sysattr_value")]
	[return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "HidSharp.Platform.Utf8Marshaler")]
	...
	[DllImport("libudev.so.0", EntryPoint = "udev_device_get_is_initialized")]
