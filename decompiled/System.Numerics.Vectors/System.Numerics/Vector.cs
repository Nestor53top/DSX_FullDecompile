...
public struct Vector<T> : IEquatable<Vector<T>>, IFormattable where T : struct
{
	...
	internal unsafe static Vector<T> Equals(Vector<T> left, Vector<T> right)
	{
		if (Vector.IsHardwareAccelerated)
		{
			if (typeof(T) == typeof(byte))
			{
				...
				for (int i = 0; i < Count; i++)
				{
					ptr[i] = (byte)(ScalarEquals(left[i], right[i]) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr);
			}
			if (typeof(T) == typeof(sbyte))
			{
				...
				for (int j = 0; j < Count; j++)
				{
					ptr2[j] = (sbyte)(ScalarEquals(left[j], right[j]) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr2);
			}
			if (typeof(T) == typeof(ushort))
			{
				...
				for (int k = 0; k < Count; k++)
				{
					ptr3[k] = (ushort)(ScalarEquals(left[k], right[k]) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr3);
			}
			if (typeof(T) == typeof(short))
			{
				...
				for (int l = 0; l < Count; l++)
				{
					ptr4[l] = (short)(ScalarEquals(left[l], right[l]) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr4);
			}
			if (typeof(T) == typeof(uint))
			{
				...
				for (int m = 0; m < Count; m++)
				{
					ptr5[m] = (ScalarEquals(left[m], right[m]) ? System.Numerics.ConstantHelper.GetUInt32WithAllBitsSet() : 0u);
				}
				return new Vector<T>(ptr5);
			}
			if (typeof(T) == typeof(int))
			{
				...
				for (int n = 0; n < Count; n++)
				{
					ptr6[n] = (ScalarEquals(left[n], right[n]) ? System.Numerics.ConstantHelper.GetInt32WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr6);
			}
			if (typeof(T) == typeof(ulong))
			{
				...
				for (int num = 0; num < Count; num++)
				{
					ptr7[num] = (ScalarEquals(left[num], right[num]) ? System.Numerics.ConstantHelper.GetUInt64WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr7);
			}
			if (typeof(T) == typeof(long))
			{
				...
				for (int num2 = 0; num2 < Count; num2++)
				{
					ptr8[num2] = (ScalarEquals(left[num2], right[num2]) ? System.Numerics.ConstantHelper.GetInt64WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr8);
			}
			if (typeof(T) == typeof(float))
			{
				...
				for (int num3 = 0; num3 < Count; num3++)
				{
					ptr9[num3] = (ScalarEquals(left[num3], right[num3]) ? System.Numerics.ConstantHelper.GetSingleWithAllBitsSet() : 0f);
				}
				return new Vector<T>(ptr9);
			}
			if (typeof(T) == typeof(double))
			{
				...
				for (int num4 = 0; num4 < Count; num4++)
				{
					ptr10[num4] = (ScalarEquals(left[num4], right[num4]) ? System.Numerics.ConstantHelper.GetDoubleWithAllBitsSet() : 0.0);
				}
				return new Vector<T>(ptr10);
			}
			throw new NotSupportedException(System.SR.Arg_TypeNotSupported);
		}
		System.Numerics.Register existingRegister = default(System.Numerics.Register);
		if (typeof(T) == typeof(byte))
		{
			existingRegister.byte_0 = (byte)((left.register.byte_0 == right.register.byte_0) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_1 = (byte)((left.register.byte_1 == right.register.byte_1) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_2 = (byte)((left.register.byte_2 == right.register.byte_2) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_3 = (byte)((left.register.byte_3 == right.register.byte_3) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_4 = (byte)((left.register.byte_4 == right.register.byte_4) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_5 = (byte)((left.register.byte_5 == right.register.byte_5) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_6 = (byte)((left.register.byte_6 == right.register.byte_6) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_7 = (byte)((left.register.byte_7 == right.register.byte_7) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_8 = (byte)((left.register.byte_8 == right.register.byte_8) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_9 = (byte)((left.register.byte_9 == right.register.byte_9) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_10 = (byte)((left.register.byte_10 == right.register.byte_10) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_11 = (byte)((left.register.byte_11 == right.register.byte_11) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_12 = (byte)((left.register.byte_12 == right.register.byte_12) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_13 = (byte)((left.register.byte_13 == right.register.byte_13) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_14 = (byte)((left.register.byte_14 == right.register.byte_14) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			existingRegister.byte_15 = (byte)((left.register.byte_15 == right.register.byte_15) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
			return new Vector<T>(ref existingRegister);
		}
		if (typeof(T) == typeof(sbyte))
		{
			existingRegister.sbyte_0 = (sbyte)((left.register.sbyte_0 == right.register.sbyte_0) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_1 = (sbyte)((left.register.sbyte_1 == right.register.sbyte_1) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_2 = (sbyte)((left.register.sbyte_2 == right.register.sbyte_2) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_3 = (sbyte)((left.register.sbyte_3 == right.register.sbyte_3) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_4 = (sbyte)((left.register.sbyte_4 == right.register.sbyte_4) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_5 = (sbyte)((left.register.sbyte_5 == right.register.sbyte_5) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_6 = (sbyte)((left.register.sbyte_6 == right.register.sbyte_6) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_7 = (sbyte)((left.register.sbyte_7 == right.register.sbyte_7) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_8 = (sbyte)((left.register.sbyte_8 == right.register.sbyte_8) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_9 = (sbyte)((left.register.sbyte_9 == right.register.sbyte_9) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_10 = (sbyte)((left.register.sbyte_10 == right.register.sbyte_10) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_11 = (sbyte)((left.register.sbyte_11 == right.register.sbyte_11) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_12 = (sbyte)((left.register.sbyte_12 == right.register.sbyte_12) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_13 = (sbyte)((left.register.sbyte_13 == right.register.sbyte_13) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_14 = (sbyte)((left.register.sbyte_14 == right.register.sbyte_14) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			existingRegister.sbyte_15 = (sbyte)((left.register.sbyte_15 == right.register.sbyte_15) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
			return new Vector<T>(ref existingRegister);
		}
		if (typeof(T) == typeof(ushort))
		{
			existingRegister.uint16_0 = (ushort)((left.register.uint16_0 == right.register.uint16_0) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
			existingRegister.uint16_1 = (ushort)((left.register.uint16_1 == right.register.uint16_1) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
			existingRegister.uint16_2 = (ushort)((left.register.uint16_2 == right.register.uint16_2) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
			existingRegister.uint16_3 = (ushort)((left.register.uint16_3 == right.register.uint16_3) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
			existingRegister.uint16_4 = (ushort)((left.register.uint16_4 == right.register.uint16_4) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
			existingRegister.uint16_5 = (ushort)((left.register.uint16_5 == right.register.uint16_5) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
			existingRegister.uint16_6 = (ushort)((left.register.uint16_6 == right.register.uint16_6) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
			existingRegister.uint16_7 = (ushort)((left.register.uint16_7 == right.register.uint16_7) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
			return new Vector<T>(ref existingRegister);
		}
		if (typeof(T) == typeof(short))
		{
			existingRegister.int16_0 = (short)((left.register.int16_0 == right.register.int16_0) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
			existingRegister.int16_1 = (short)((left.register.int16_1 == right.register.int16_1) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
			existingRegister.int16_2 = (short)((left.register.int16_2 == right.register.int16_2) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
			existingRegister.int16_3 = (short)((left.register.int16_3 == right.register.int16_3) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
			existingRegister.int16_4 = (short)((left.register.int16_4 == right.register.int16_4) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
			existingRegister.int16_5 = (short)((left.register.int16_5 == right.register.int16_5) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
			existingRegister.int16_6 = (short)((left.register.int16_6 == right.register.int16_6) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
			existingRegister.int16_7 = (short)((left.register.int16_7 == right.register.int16_7) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
			return new Vector<T>(ref existingRegister);
		}
		if (typeof(T) == typeof(uint))
		{
			existingRegister.uint32_0 = ((left.register.uint32_0 == right.register.uint32_0) ? System.Numerics.ConstantHelper.GetUInt32WithAllBitsSet() : 0u);
			existingRegister.uint32_1 = ((left.register.uint32_1 == right.register.uint32_1) ? System.Numerics.ConstantHelper.GetUInt32WithAllBitsSet() : 0u);
			existingRegister.uint32_2 = ((left.register.uint32_2 == right.register.uint32_2) ? System.Numerics.ConstantHelper.GetUInt32WithAllBitsSet() : 0u);
			existingRegister.uint32_3 = ((left.register.uint32_3 == right.register.uint32_3) ? System.Numerics.ConstantHelper.GetUInt32WithAllBitsSet() : 0u);
			return new Vector<T>(ref existingRegister);
		}
		if (typeof(T) == typeof(int))
		{
			existingRegister.int32_0 = ((left.register.int32_0 == right.register.int32_0) ? System.Numerics.ConstantHelper.GetInt32WithAllBitsSet() : 0);
			existingRegister.int32_1 = ((left.register.int32_1 == right.register.int32_1) ? System.Numerics.ConstantHelper.GetInt32WithAllBitsSet() : 0);
			existingRegister.int32_2 = ((left.register.int32_2 == right.register.int32_2) ? System.Numerics.ConstantHelper.GetInt32WithAllBitsSet() : 0);
			existingRegister.int32_3 = ((left.register.int32_3 == right.register.int32_3) ? System.Numerics.ConstantHelper.GetInt32WithAllBitsSet() : 0);
			return new Vector<T>(ref existingRegister);
		}
		if (typeof(T) == typeof(ulong))
		{
			existingRegister.uint64_0 = ((left.register.uint64_0 == right.register.uint64_0) ? System.Numerics.ConstantHelper.GetUInt64WithAllBitsSet() : 0);
			existingRegister.uint64_1 = ((left.register.uint64_1 == right.register.uint64_1) ? System.Numerics.ConstantHelper.GetUInt64WithAllBitsSet() : 0);
			return new Vector<T>(ref existingRegister);
		}
		if (typeof(T) == typeof(long))
		{
			existingRegister.int64_0 = ((left.register.int64_0 == right.register.int64_0) ? System.Numerics.ConstantHelper.GetInt64WithAllBitsSet() : 0);
			existingRegister.int64_1 = ((left.register.int64_1 == right.register.int64_1) ? System.Numerics.ConstantHelper.GetInt64WithAllBitsSet() : 0);
			return new Vector<T>(ref existingRegister);
		}
		if (typeof(T) == typeof(float))
		{
			existingRegister.single_0 = ((left.register.single_0 == right.register.single_0) ? System.Numerics.ConstantHelper.GetSingleWithAllBitsSet() : 0f);
			existingRegister.single_1 = ((left.register.single_1 == right.register.single_1) ? System.Numerics.ConstantHelper.GetSingleWithAllBitsSet() : 0f);
			existingRegister.single_2 = ((left.register.single_2 == right.register.single_2) ? System.Numerics.ConstantHelper.GetSingleWithAllBitsSet() : 0f);
			existingRegister.single_3 = ((left.register.single_3 == right.register.single_3) ? System.Numerics.ConstantHelper.GetSingleWithAllBitsSet() : 0f);
			return new Vector<T>(ref existingRegister);
		}
		if (typeof(T) == typeof(double))
		{
			existingRegister.double_0 = ((left.register.double_0 == right.register.double_0) ? System.Numerics.ConstantHelper.GetDoubleWithAllBitsSet() : 0.0);
			existingRegister.double_1 = ((left.register.double_1 == right.register.double_1) ? System.Numerics.ConstantHelper.GetDoubleWithAllBitsSet() : 0.0);
			return new Vector<T>(ref existingRegister);
		}
		throw new NotSupportedException(System.SR.Arg_TypeNotSupported);
	}
	...
	internal unsafe static Vector<T> LessThan(Vector<T> left, Vector<T> right)
	{
		if (Vector.IsHardwareAccelerated)
		{
			if (typeof(T) == typeof(byte))
			{
				...
				for (int i = 0; i < Count; i++)
				{
					ptr[i] = (byte)(ScalarLessThan(left[i], right[i]) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr);
			}
			if (typeof(T) == typeof(sbyte))
			{
				...
				for (int j = 0; j < Count; j++)
				{
					ptr2[j] = (sbyte)(ScalarLessThan(left[j], right[j]) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr2);
			}
			if (typeof(T) == typeof(ushort))
			{
				...
				for (int k = 0; k < Count; k++)
				{
					ptr3[k] = (ushort)(ScalarLessThan(left[k], right[k]) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr3);
			}
			if (typeof(T) == typeof(short))
			{
				...
				for (int l = 0; l < Count; l++)
				{
					ptr4[l] = (short)(ScalarLessThan(left[l], right[l]) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr4);
			}
			if (typeof(T) == typeof(uint))
			{
				...
				for (int m = 0; m < Count; m++)
				{
					ptr5[m] = (ScalarLessThan(left[m], right[m]) ? System.Numerics.ConstantHelper.GetUInt32WithAllBitsSet() : 0u);
				}
				return new Vector<T>(ptr5);
			}
			if (typeof(T) == typeof(int))
			{
				...
				for (int n = 0; n < Count; n++)
				{
					ptr6[n] = (ScalarLessThan(left[n], right[n]) ? System.Numerics.ConstantHelper.GetInt32WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr6);
			}
			if (typeof(T) == typeof(ulong))
			{
				...
				for (int num = 0; num < Count; num++)
				{
					ptr7[num] = (ScalarLessThan(left[num], right[num]) ? System.Numerics.ConstantHelper.GetUInt64WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr7);
			}
			if (typeof(T) == typeof(long))
			{
				...
				for (int num2 = 0; num2 < Count; num2++)
				{
					ptr8[num2] = (ScalarLessThan(left[num2], right[num2]) ? System.Numerics.ConstantHelper.GetInt64WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr8);
			}
			if (typeof(T) == typeof(float))
			{
				...
				for (int num3 = 0; num3 < Count; num3++)
				{
					ptr9[num3] = (ScalarLessThan(left[num3], right[num3]) ? System.Numerics.ConstantHelper.GetSingleWithAllBitsSet() : 0f);
				}
				return new Vector<T>(ptr9);
			}
			if (typeof(T) == typeof(double))
			{
				...
				for (int num4 = 0; num4 < Count; num4++)
				{
					ptr10[num4] = (ScalarLessThan(left[num4], right[num4]) ? System.Numerics.ConstantHelper.GetDoubleWithAllBitsSet() : 0.0);
				}
				return new Vector<T>(ptr10);
			}
			throw new NotSupportedException(System.SR.Arg_TypeNotSupported);
	...
	internal unsafe static Vector<T> GreaterThan(Vector<T> left, Vector<T> right)
	{
		if (Vector.IsHardwareAccelerated)
		{
			if (typeof(T) == typeof(byte))
			{
				...
				for (int i = 0; i < Count; i++)
				{
					ptr[i] = (byte)(ScalarGreaterThan(left[i], right[i]) ? System.Numerics.ConstantHelper.GetByteWithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr);
			}
			if (typeof(T) == typeof(sbyte))
			{
				...
				for (int j = 0; j < Count; j++)
				{
					ptr2[j] = (sbyte)(ScalarGreaterThan(left[j], right[j]) ? System.Numerics.ConstantHelper.GetSByteWithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr2);
			}
			if (typeof(T) == typeof(ushort))
			{
				...
				for (int k = 0; k < Count; k++)
				{
					ptr3[k] = (ushort)(ScalarGreaterThan(left[k], right[k]) ? System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr3);
			}
			if (typeof(T) == typeof(short))
			{
				...
				for (int l = 0; l < Count; l++)
				{
					ptr4[l] = (short)(ScalarGreaterThan(left[l], right[l]) ? System.Numerics.ConstantHelper.GetInt16WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr4);
			}
			if (typeof(T) == typeof(uint))
			{
				...
				for (int m = 0; m < Count; m++)
				{
					ptr5[m] = (ScalarGreaterThan(left[m], right[m]) ? System.Numerics.ConstantHelper.GetUInt32WithAllBitsSet() : 0u);
				}
				return new Vector<T>(ptr5);
			}
			if (typeof(T) == typeof(int))
			{
				...
				for (int n = 0; n < Count; n++)
				{
					ptr6[n] = (ScalarGreaterThan(left[n], right[n]) ? System.Numerics.ConstantHelper.GetInt32WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr6);
			}
			if (typeof(T) == typeof(ulong))
			{
				...
				for (int num = 0; num < Count; num++)
				{
					ptr7[num] = (ScalarGreaterThan(left[num], right[num]) ? System.Numerics.ConstantHelper.GetUInt64WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr7);
			}
			if (typeof(T) == typeof(long))
			{
				...
				for (int num2 = 0; num2 < Count; num2++)
				{
					ptr8[num2] = (ScalarGreaterThan(left[num2], right[num2]) ? System.Numerics.ConstantHelper.GetInt64WithAllBitsSet() : 0);
				}
				return new Vector<T>(ptr8);
			}
			if (typeof(T) == typeof(float))
			{
				...
				for (int num3 = 0; num3 < Count; num3++)
				{
					ptr9[num3] = (ScalarGreaterThan(left[num3], right[num3]) ? System.Numerics.ConstantHelper.GetSingleWithAllBitsSet() : 0f);
				}
				return new Vector<T>(ptr9);
			}
			if (typeof(T) == typeof(double))
			{
				...
				for (int num4 = 0; num4 < Count; num4++)
				{
					ptr10[num4] = (ScalarGreaterThan(left[num4], right[num4]) ? System.Numerics.ConstantHelper.GetDoubleWithAllBitsSet() : 0.0);
				}
				return new Vector<T>(ptr10);
			}
			throw new NotSupportedException(System.SR.Arg_TypeNotSupported);
	...
	internal unsafe static Vector<T> Abs(Vector<T> value)
	{
		...
		if (Vector.IsHardwareAccelerated)
		{
			if (typeof(T) == typeof(sbyte))
			{
				sbyte* ptr = stackalloc sbyte[(int)checked(unchecked((nuint)(uint)Count) * (nuint)1u)];
				for (int i = 0; i < Count; i++)
				{
	...
	private static T GetAllBitsSetValue()
	{
		if (typeof(T) == typeof(byte))
		{
			return (T)(object)System.Numerics.ConstantHelper.GetByteWithAllBitsSet();
		}
		if (typeof(T) == typeof(sbyte))
		{
			return (T)(object)System.Numerics.ConstantHelper.GetSByteWithAllBitsSet();
		}
		if (typeof(T) == typeof(ushort))
		{
			return (T)(object)System.Numerics.ConstantHelper.GetUInt16WithAllBitsSet();
		}
		if (typeof(T) == typeof(short))
		{
			return (T)(object)System.Numerics.ConstantHelper.GetInt16WithAllBitsSet();
		}
		if (typeof(T) == typeof(uint))
		{
			return (T)(object)System.Numerics.ConstantHelper.GetUInt32WithAllBitsSet();
		}
		if (typeof(T) == typeof(int))
		{
			return (T)(object)System.Numerics.ConstantHelper.GetInt32WithAllBitsSet();
		}
		if (typeof(T) == typeof(ulong))
		{
			return (T)(object)System.Numerics.ConstantHelper.GetUInt64WithAllBitsSet();
		}
		if (typeof(T) == typeof(long))
		{
			return (T)(object)System.Numerics.ConstantHelper.GetInt64WithAllBitsSet();
		}
		if (typeof(T) == typeof(float))
		{
			return (T)(object)System.Numerics.ConstantHelper.GetSingleWithAllBitsSet();
		}
		if (typeof(T) == typeof(double))
		{
			return (T)(object)System.Numerics.ConstantHelper.GetDoubleWithAllBitsSet();
		}
		throw new NotSupportedException(System.SR.Arg_TypeNotSupported);
	}
}
