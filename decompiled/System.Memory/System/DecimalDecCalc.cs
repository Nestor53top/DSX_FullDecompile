...
internal static class DecimalDecCalc
{
	...
	internal static uint DecDivMod1E9(ref System.MutableDecimal value)
	{
		return D32DivMod1E9(D32DivMod1E9(D32DivMod1E9(0u, ref value.High), ref value.Mid), ref value.Low);
	}

	internal static void DecAddInt32(ref System.MutableDecimal value, uint i)
	{
	...
	internal static void DecMul10(ref System.MutableDecimal value)
	{
		System.MutableDecimal d = value;
	...
	private static void DecShiftLeft(ref System.MutableDecimal value)
	{
	...
	private static void DecAdd(ref System.MutableDecimal value, System.MutableDecimal d)
	{
