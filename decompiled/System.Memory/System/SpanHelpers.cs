...
internal static class SpanHelpers
{
	...
	public static class PerTypeValues<T>
	{
		...
		{
			T[] array = new T[1];
			return Unsafe.ByteOffset(ref Unsafe.As<System.Pinnable<T>>(array).Data, ref array[0]);
		}
	}
	...
	public unsafe static bool SequenceEqual(ref byte first, ref byte second, System.NUInt length)
	{
