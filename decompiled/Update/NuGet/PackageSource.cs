...
internal class PackageSource : IEquatable<PackageSource>
{
	...
	public bool Equals(PackageSource other)
	{
		...
		if (Name.Equals(other.Name, StringComparison.CurrentCultureIgnoreCase))
		{
			return Source.Equals(other.Source, StringComparison.OrdinalIgnoreCase);
		}
		return false;
	}
