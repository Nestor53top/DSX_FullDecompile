...
internal class ResourceAccessor
{
	...
	{
		_controlType = controlType ?? throw new ArgumentNullException("controlType");
	}
	...
	public string GetLocalizedStringResource(string resourceName)
	{
		...
		{
			Assembly assembly = _controlType.Assembly;
			string? name = assembly.GetName().Name;
			string name2 = _controlType.Name;
			string baseName = name + "." + name2 + ".Strings.Resources";
