...
internal abstract class EventRevoker<TSource, TDelegate> where TSource : class where TDelegate : Delegate
{
	...
	public void Revoke()
	{
		if (_source != null && _handler != null && _source.TryGetTarget(out var target) && _handler.TryGetTarget(out var target2))
		{
			RemoveHandler(target, target2);
		}
		_source = null;
		_handler = null;
	}
