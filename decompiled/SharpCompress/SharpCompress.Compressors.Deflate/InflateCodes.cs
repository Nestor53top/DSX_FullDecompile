		...
		while (true)
		{
			...
			case 1:
			{
				...
				for (num7 = need; num2 < num7; num2 += 8)
				{
					...
					int num11 = (tree_index + (num & InternalInflateConstants.InflateMask[num2])) * 3;
					if (num2 >= tree[num11 + 1])
					{
						break;
					}
					blocks.bitb = num;
				...
				int num9 = (tree_index + (num & InternalInflateConstants.InflateMask[num7])) * 3;
				num >>= tree[num9 + 1];
				num2 -= tree[num9 + 1];
				int num10 = tree[num9];
				if (num10 == 0)
			...
			case 3:
			{
				...
				for (num7 = need; num2 < num7; num2 += 8)
				{
					...
					int num8 = (tree_index + (num & InternalInflateConstants.InflateMask[num2])) * 3;
					if (num2 >= tree[num8 + 1])
					{
						break;
					}
