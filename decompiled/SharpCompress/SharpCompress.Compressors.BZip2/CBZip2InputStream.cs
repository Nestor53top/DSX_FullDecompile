...
internal class CBZip2InputStream : Stream
{
	...
	private readonly int[][] limit = InitIntArray(6, 258);

	private readonly int[][] basev = InitIntArray(6, 258);

	private readonly int[][] perm = InitIntArray(6, 258);
	...
	private bool Complete()
	{
		...
		{
			num = ((!Initialize(isFirstStream: false)) ? 1 : 0);
			if (num == 0)
			{
				goto IL_0044;
			}
