...
public abstract class AbstractDeviceInformationHelper : IDeviceInformationHelper
{
	...
	public virtual Task<Microsoft.AppCenter.Ingestion.Models.Device> GetDeviceInformationAsync()
	{
		return Task.Run(() => GetDeviceInformation());
	}

	public virtual Microsoft.AppCenter.Ingestion.Models.Device GetDeviceInformation()
	{
		return new Microsoft.AppCenter.Ingestion.Models.Device
		{
			SdkName = GetSdkName(),
	...
	{
		AbstractDeviceInformationHelper.InformationInvalidated?.Invoke(sender, e);
	}
